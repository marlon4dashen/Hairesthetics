...
//            if let dat = self.img{
//                let b64 = UIImage(cgImage: dat).pngData()?.base64EncodedString().appending("\n")
...
//    ){
////    public func metadataOutput(_ captureOutput: AVCaptureMetadataOutput, didOutput sampleBuffer: CMSampleBuffer, from connection: AVCaptureConnection){
